...
def decode(text, space):
    return code(text, -space, [])
...
while True:
    action = input("Выберите действие (шифровать/дешифровать/выход): ").lower()
    if action == "выход":
        break
    ...
    if action == "шифровать":
        ...
        print('Зашифрованное сообщение:', ''.join(fin))
    elif action == "дешифровать":
        fin = decode(text, space)
        print('Расшифрованное сообщение:', ''.join(fin))
    else:
